class GameOver extends Phaser.Scene {
    ...
    create() {
       ...
       my.sprite.meteors = this.add.group({
        ...
        my.sprite.button1Text = this.add.text(my.screenCenterX, my.sprite.button1.y, 'Retry?', { font: '32px Roboto', fill: '#FFFFFF' }).setOrigin(.5);
        ...
        my.sprite.gO = this.add.text(my.screenCenterX, 167, 'Game OVER!', { font: '32px Roboto', fill: '#FFFFFF' }).setOrigin(.5);
